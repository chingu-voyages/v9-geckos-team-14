...
describe("API Palletes", function() {
  ...
  describe("POST /api/palletes/new", function() {
    ...
    it.only("Should respond with json", function() {
      return request(app)
        .post("/api/palletes/new")
        .set({
          Accept: "application/json",
    ...
    it("Should respond with status 400 if no name");

    it("Should respond with status 400 if no colors");

    it("Should respond with pallete id");

    it("Should respond with single object");
  });
});
